...
Function RemoveObsoleteFiles([String] $sitePath)
{
    ...
    $amazonProviders = Join-Path $sitePath "Bin\Mediachase.Library.AmazonProviders.dll";
    if(Test-Path($amazonProviders)) {
        Write-Host "Removing file $amazonProviders"
        Remove-Item $amazonProviders
    }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUapRvNNXcEyc+3fYEAZRchKXu
# v1GgghLKMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# BBSt6Og3XZeXREbKogvKIsV+rzw5vTANBgkqhkiG9w0BAQEFAASCAQAi0bznRtFi
# xe5eT0PLSp3ylrglLR/eGG/0m55W8P1RXmj2BziTaR4gRLt99MB26S9ZmTf1qGZy
# n65v06MAPLbMIV5B2xtdkmV9U5mE/Jwgom9J5KzLoYAPQf4LAQ6j/sBIapynhLkb
# aQMs+N/XT+drNxtGp4SiO6vvRLruRRRQpPWL1S+7v8NHXJE5tj+vRHxh7dQwLCis
# Tiid7r0KtAP1HTH95P0FxV7eyWYcsuPkuIMjcCey2BoYFdvMIxLCPv0/O8AD1MWQ
# sKNVg9c/EH2lHBVx1kfDUgeEFDTKtRqE0TwMZc5/soETYV9557ICcwgGWEj6uftW
# WXHDF+focb7BoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgwggH0AgEBMHIwXjELMAkG
...
# BwEwHAYJKoZIhvcNAQkFMQ8XDTE3MTEzMDA3MjgzM1owIwYJKoZIhvcNAQkEMRYE
# FH4QcpEQLRt6S1eaZ1ZPjHqBqIdEMA0GCSqGSIb3DQEBAQUABIIBAAaYaZaidOLx
# rB6foJ+QNYxrn53cQpZ5vEgmagNMY8JTxLQXPAI4nkvGBACgj+5TR3cPdh28KFmm
# RcQx3hv0ulNhdbVSfN2/o3YO5HnsJVA8XlZF+DEwfsOmCTKnHpHXGnxiiquYG7Yb
# AcX4jkYCGQffx+u0STrW/a7wSJ/bg9yRDkOfIoEF9hOoqsdMbnCvjqy04qfI2aeN
# 39pxS3zKkDTJGJpuOwOCOcb96dANGHk0pdVoTEp8+a7GPgENblqfBQBb4rxq505R
# MZbN7ckQMpyDk9v6kKsgjSgnNLQ9hGhXVyyIQcHM9Cs+iUVBCBe+EbSvJbotxkkV
# 0zZMRl202zE=
